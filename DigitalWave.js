...
class DigitalWave {
	...
	drawOnCanvas() {
		...
		let pixelRatio = this.pixel_ratio;
		this.canvas.width = this.sim_length * this.time_period_width_in_canvas * pixelRatio;
		this.canvas.height = (this.canvas_height + 10) * pixelRatio;
		//this.canvas.setAttribute('width', "" + (this.sim_length * this.time_period_width_in_canvas * pixelRatio));
		//this.canvas.setAttribute('height', '' + parseInt(this.canvas_height + 10) * pixelRatio);
		//this.canvas.setAttribute("style", "border: 2px solid black");
		this.canvas.style.width = this.sim_length * this.time_period_width_in_canvas * pixelRatio + 'px';
		this.canvas.style.height = (this.canvas_height + 10) * pixelRatio + 'px';
